...
class ViewTransactionDialog(private val list: TransactionData, private var position: Int) : DialogFragment() {
    ...
    private fun removeData(list: TransactionData) {
        ...
        Toast.makeText(context,"com.example.moneymanagementproject.Transaction Deleted", Toast.LENGTH_LONG).show()
        Transaction.arrayListTransaction.removeAt(position)
        dismiss()
    }
